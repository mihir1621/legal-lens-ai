...
const sections = [
    {
        ...
        content: "We only collect your email and name. Your uploaded documents are analyzed in real-time and never stored on our servers."
    },
    {
        icon: Lock,
        title: "No Tracking",
        content: "We don't use ads, trackers, or analytics. Only essential login cookies and reCAPTCHA for security."
    },
    {
        icon: Trash2,
        title: "You're in Control",
        content: "Delete your account and all data anytime. Your privacy is our priority."
    }
];
            ...
            <div className="container mx-auto max-w-3xl px-4 py-16 relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-xs font-medium text-primary mb-4">
                        <Shield className="h-3 w-3" /> Your Data, Your Control
                    </div>
